...
This suggests a comparison. If MSR and MSE are of the same order of magnitude, then we can assume $\beta_1 = 0$. If, however, MSR > MSE, then $\beta_1 \neq 0$ (e.g. there is a non-zero linear relationship between x and y). This is the basic idea underlying the ANOVA.
